...
= How does it works? =
1. Upload your desired logo clicking the Upload Image button.
2. Provide your custom height and width for the logo and press Update.
3. That's it! You can now logout and check your awesome new login page.
...
= 2.4.0 =
* Fixed deprecated login_headertitle
* Tested wordpress version 5.7. 

= 2.3.3 =
* Fix prefill of old selected logo in input field.

= 2.3.2 =
* Improved settings page with media uploader.
...
= 2.3.0 =
* Fix css layout in options page.
* Add new plugin logo.
* Align to new version and tested to WordPress v5.2.3
